...
<div class="main-panel">
    <div class="content-wrapper">
        ...
        <div style="text-align:center ; padding-top:10px">
          <h2 style="font-size: 10px;text-align:left">Add Product</h2><br>
        <form action="{{url('/Add_Product')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row mb-3">
                <label for="" class="col-sm-2 col-form-label">Product Name :</label>
                <div class="col-sm-10">
                  <input type="text" name="title" style="color: white" placeholder="Write Product Name" class="form-control" required><br>
               </div>
              </div>
              <div class="row mb-3">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <textarea name="description" style="color: white" class="form-control" required></textarea>
                </div>
              </div>
              <div class="row mb-3">
                  <label for="" class="col-sm-2 col-form-label">Product Price :</label>
                  <div class="col-sm-10">
                      <input type="number" style="color: white" name="price" placeholder="Write Product Price" required class="form-control"><br>
                  </div>
                </div> <div class="row mb-3">
                  <label for="" class="col-sm-2 col-form-label">Discount Price :</label>
                  <div class="col-sm-10">
                      <input type="number" style="color: white" name="dis_price" placeholder="Write Discount Price" class="form-control"><br>
                  </div>
                </div> <div class="row mb-3">
                  <label for="" class="col-sm-2 col-form-label">Product Quantity :</label>
                  <div class="col-sm-10">
                      <input type="number" style="color: white" min="0" name="quantity" class="form-control" placeholder="Write Product Quantity"><br>
                  </div>
                </div>
            </div>
             <div class="row mb-3">
