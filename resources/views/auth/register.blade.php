<x-guest-layout>
    <x-jet-authentication-card>
        <x-slot name="logo">
            <img src="home/images/favicon.png" style="width:100px">
        </x-slot>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email')" placeholder="Only Gmail account" required />
            </div>
            ...
            <div class="mt-4">
                ...
                <select required name="address" id="address" :value="old('address')" class="block mt-1 w-full">
